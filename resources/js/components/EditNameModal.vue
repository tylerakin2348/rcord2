    ...
    <div class="bg-white rounded-lg shadow-lg w-full max-w-md p-6">
      ...
      <form @submit.prevent="submit">
        <div class="mb-4">
          ...
          <input v-model="name" type="text" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-stone-500 focus:border-transparent" required />
        </div>
...
watch(() => props.isOpen, (open) => { if (open) { name.value = store.user?.name || ''; error.value = '' } })
